...
/**
 * Created by paulhasfjord on 21.12.2016.
 */
public class Book3Test {
    ...
    public void nullValueBook3Test() throws Exception {
        ...
        Set<ConstraintViolation<Book3>> violations = validator.validate(book);
    ...
    @Test
    public void shouldRaiseConstraintViolationsCausedByInvalidQuanity() throws Exception {

        Book3 book0 = new Book3(1, ItemType.DUMMY_NOT_IN_LIST, "Vanessa", 30f, "En bok om en ungdomsjente", "1321224566772", new Date("2/2/1990 20:00:00 GMT"), false, 400, 1, "Arne Berggren", "Cappelen", 1999);
        Set<ConstraintViolation<Book3>> violations = validator.validate(book0);
    ...
    public void shouldRaiseConstraintViolationsCausedByInvalidItemType() throws Exception {
        Book3 book000 = new Book3(0, ItemType.BOOK, "Vanessa", 30f, "En bok om en ungdomsjente", "1321224566772", new Date("2/2/1990 20:00:00 GMT"), false, 400, 1, "Arne Berggren", "Cappelen", 1999);
        Set<ConstraintViolation<Book3>> violations = validator.validate(book000);
        assertEquals(1, violations.size());
    ...
    public void shouldRaiseConstraintViolationsCausedByInvalidTitleIsOneLetter() throws Exception {
        ...
        Book3 book00 = new Book3(1, ItemType.BOOK, "V", 30f, "En bok om en ungdomsjente", "1321224566772", new Date("2/2/1990 20:00:00 GMT"), false, 400, 1, "Arne Berggren", "Cappelen", 1999);
        Set<ConstraintViolation<Book3>> violations = validator.validate(book00);
        assertEquals(1, violations.size());
    ...
    public void shouldRaiseConstraintViolatonsCausedByInvalidPriceIsNull() throws Exception {
        Book3 book1 = new Book3(1, ItemType.BOOK, "Vanessa", 0f, "En bok om en ungdomsjente", "1321224566772", new Date("2/2/1990 20:00:00 GMT"), false, 400, 1, "Arne Berggren",  "Cappelen", 1999);
        Set<ConstraintViolation<Book3>> violations = validator.validate(book1);
        assertEquals(1, violations.size());
    ...
    public void shouldRaiseConstraintViolationsCausedByInvalidDescriptionMoreThan200Letters() throws Exception {
        Book3 book2 = new Book3(1, ItemType.BOOK, "Vanessa", 30f, "En bok om en ungdomsjente json ipsum dipsum Arne Berggren json ipsum dipsumArne Berggren json ipsum dipsumArne Berggren json ipsum dipsumArne Berggren json ipsum dipsum ipsum dipsumArne Berggren json ipsum dipsumArne Berggren json ipsum dipsumArne Berggren json ipsum dipsum ipsum dipsumArne Berggren json ipsum dipsumArne Berggren json ipsum dipsumArne Berggren json ipsum dipsum", "1321224566772", new Date("2/2/1990"), false, 400, 1, "Arne Berggren", "Cappelen",1999);
        Set<ConstraintViolation<Book3>> violations = validator.validate(book2);
        assertEquals(1, violations.size());
    ...
    public void shouldRaiseConstraintViolationsCausedByInvalidIsbnHas12digits() throws Exception {
        Book3 book3 = new Book3(1, ItemType.BOOK, "Vanessa", 30f, "En bok om en ungdomsjente", "13-122456677", new Date("2/2/1990 20:00:00 GMT"), false, 400, 1, "Arne Berggren", "Cappelen", 1999);
        Set<ConstraintViolation<Book3>> violations = validator.validate(book3);
        assertEquals(1, violations.size());
    ...
    public void shouldRaiseConstraintViolationsCausedByInvalidDateIsInTheFuture() throws Exception {
        ...
        Book3 book4 = new Book3(1, ItemType.BOOK, "Vanessa", 30f, "En bok om en ungdomsjente", "1321224566772", date, false, 400, 1, "Arne Berggren", "Cappelen", 1999);
        Set<ConstraintViolation<Book3>> violations = validator.validate(book4);
        assertEquals(1, violations.size());
    ...
    public void shouldRaiseConstraintViolationsCausedByInvalidIllustration() throws Exception {
        Book3 book5 = new Book3(1, ItemType.BOOK, "Vanessa", 30f, "En bok om en ungdomsjente", "1321224566772", new Date("2/2/1990 20:00:00 GMT"), null, 400, 1, "Arne Berggren", "Cappelen", 1999);
        Set<ConstraintViolation<Book3>> violations = validator.validate(book5);
        assertEquals(1, violations.size());
    ...
    public void shouldRaiseConstraintViolationsCausedByInvalidPageNumberIsToLow() throws Exception {
        Book3 book6 = new Book3(1, ItemType.BOOK, "Vanessa", 30f, "En bok om en ungdomsjente", "1321224566772", new Date("2/2/1990 20:00:00 GMT"), false, 5, 1, "Arne Berggren", "Cappelen", 1999);
        Set<ConstraintViolation<Book3>> violations = validator.validate(book6);
        assertEquals(1, violations.size());
    ...
    public void shouldRaiseConstraintViolationsCausedByInvalidVersionNumber() throws Exception {
        Book3 book7 = new Book3(1, ItemType.BOOK, "Vanessa", 30f, "En bok om en ungdomsjente", "1321224566772", new Date("2/2/1990 20:00:00 GMT"), false, 400, 0, "Arne Berggren", "Cappelen", 1999);
        Set<ConstraintViolation<Book3>> violations = validator.validate(book7);
        assertEquals(1, violations.size());
        assertEquals("must be greater than or equal to 1", violations.iterator().next().getMessage());
        assertEquals(0, violations.iterator().next().getInvalidValue());
        assertEquals("{javax.validation.constraints.Min.message}", violations.iterator().next().getMessageTemplate());
    ...
    public void shouldRaiseConstraintViolationsCausedByInvalidAuthor() throws Exception {
        Book3 book8 = new Book3(1, ItemType.BOOK, "Vanessa", 30f, "En bok om en ungdomsjente", "1321224566772", new Date("2/2/1990 20:00:00 GMT"), false, 400, 1, "", "Cappelen", 1999);
        Set<ConstraintViolation<Book3>> violations = validator.validate(book8);
        assertEquals(1, violations.size());
    ...
    public void shouldRaiseConstraintViolationsCausedByInvalidEditor() throws Exception {
        Book3 book9 = new Book3(1, ItemType.BOOK, "Vanessa", 30f, "En bok om en ungdomsjente", "1321224566772", new Date("2/2/1990 20:00:00 GMT"), false, 400, 1, "Arne Berggren", "", 1999);
        Set<ConstraintViolation<Book3>> violations = validator.validate(book9);
        assertEquals(1, violations.size());
    ...
    public void shouldRaiseConstraintViolationsCausedByInvalidYearIsToEarly() throws Exception {
        Book3 book9 = new Book3(1, ItemType.BOOK, "Vanessa", 30f, "En bok om en ungdomsjente", "1321224566772", new Date("2/2/1990 20:00:00 GMT"), false, 400, 1, "Arne Berggren","Cappelen", 1500);
        Set<ConstraintViolation<Book3>> violations = validator.validate(book9);
        assertEquals(1, violations.size());
