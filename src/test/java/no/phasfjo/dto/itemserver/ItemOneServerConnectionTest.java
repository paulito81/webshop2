package no.phasfjo.dto.itemserver;

//import no.phasfjo.util.ItemServerConnection;
import no.phasfjo.util.Error;
import no.phasfjo.util.ItemServerConnection;
 ...
 */
public class ItemOneServerConnectionTest {
    ...
    public void shoulRaiseConstraintViolationsCausedByInvalidResourceURL() throws Exception {
        ...
        ItemServerConnection itemServer = new ItemServerConnection("dummys", "http://www.paulswarehouse.com/", "ftp://www.paulswarehouse.com:21");
        Set<ConstraintViolation<ItemServerConnection>> violations = validator.validate(itemServer);

        displayConstraintsViolations(violations);
        assertEquals(1, violations.size());
        assertEquals("dummys", violations.iterator().next().getInvalidValue());
    ...
    public void shouldRaiseConstraintViolationsCausedByInvalidItemURL() throws Exception {
        ...
        ItemServerConnection itemServer2 = new ItemServerConnection("http://www.paulswarehouse.com/1", "dumm", "ftp://www.paulswarehouse.com:21");
        Set<ConstraintViolation<ItemServerConnection>> violations = validator.validate(itemServer2);

        displayConstraintsViolations(violations);
        assertEquals(1, violations.size());
        assertEquals("dumm", violations.iterator().next().getInvalidValue());
        assertEquals("must be a valid URL", violations.iterator().next().getMessage());
        assertEquals("{org.hibernate.validator.constraints.URL.message}", violations.iterator().next().getMessageTemplate());
    }
    ...
    public void shouldRaiseConstraintViolationsCausedByInvalidFtpServerURL() throws Exception {
        ...
        ItemServerConnection itemServer3 = new ItemServerConnection("http://www.paulswarehouse.com/1", "http://www.paulswarehouse.com/12", "dum");
        Set<ConstraintViolation<ItemServerConnection>> violations = validator.validate(itemServer3);

        displayConstraintsViolations(violations);
        assertEquals(1, violations.size());
        assertEquals("dum", violations.iterator().next().getInvalidValue());
        assertEquals("must be a valid URL", violations.iterator().next().getMessage());
        assertEquals("{org.hibernate.validator.constraints.URL.message}", violations.iterator().next().getMessageTemplate());
    }
