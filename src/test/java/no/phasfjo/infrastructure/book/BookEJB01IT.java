...
public class BookEJB01IT {
  ...
  //  assertNotNull(ctx.lookup("java:comp/env/org.agoncal.book.javaee7.chapter07.ex01.BookEJB01/ds"));
    assertNotNull(ctx.lookup("java:global/classes/BookEJB01!no.phasfjo.infrastructure.book.BookEJB01"));
    assertNotNull(ctx.lookup("java:global/classes/BookEJB01"));

    // Looks up the EJB
    BookEJB01 bookEJB = (BookEJB01) ctx.lookup("java:global/classes/BookEJB01!no.phasfjo.infrastructure.book.BookEJB01");
